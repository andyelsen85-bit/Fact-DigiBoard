...
- App language is a single admin-set setting (`settings.language`), read publicly via `GET /api/language` (login page needs it pre-auth); writes validated to fr|en|de|nl.
