          ...
          {isLoading ? (
            ...
            filtered.map((p) => {
              ...
              return (
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-muted border shrink-0 overflow-hidden flex items-center justify-center text-xs font-medium text-muted-foreground relative transition-transform duration-200 hover:scale-[4] hover:z-10">
                    {p.photo
