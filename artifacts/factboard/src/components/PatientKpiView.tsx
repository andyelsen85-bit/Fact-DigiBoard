          ...
          {isLoading ? (
            ...
            filtered.map((p) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-muted border shrink-0 overflow-hidden flex items-center justify-center text-sm font-medium text-muted-foreground relative transition-transform duration-200 hover:scale-[4] hover:z-10">
                    {p.photo
